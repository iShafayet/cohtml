...
describe.only 'Scenario Based Tests', ->
  ...
  it 'Scenario 41. Two tags with two attribute, a space at the end of the second attribute', ->

    input = fs.readFileSync './test/scenarios/scenario-41-input.cohtml', 'utf8'
    # console.log input
    output = toHtml5 input
    # console.log output
    expectedOutput = fs.readFileSync './test/scenarios/scenario-41-expected.html', 'utf8'
    # console.log expectedOutput
    expect(output).to.equal(expectedOutput)

  it 'Scenario 42. Two tags with two attribute, a space at the beginning and end of the second attribute', ->

    input = fs.readFileSync './test/scenarios/scenario-42-input.cohtml', 'utf8'
    # console.log input
    output = toHtml5 input
    # console.log output
    expectedOutput = fs.readFileSync './test/scenarios/scenario-42-expected.html', 'utf8'
    # console.log expectedOutput
    expect(output).to.equal(expectedOutput)

  it 'Scenario 43. Two tags with two attributes, two spaces at the beginning of the two attributes', ->

    input = fs.readFileSync './test/scenarios/scenario-43-input.cohtml', 'utf8'
    # console.log input
    output = toHtml5 input
    # console.log output
    expectedOutput = fs.readFileSync './test/scenarios/scenario-43-expected.html', 'utf8'
    # console.log expectedOutput
    expect(output).to.equal(expectedOutput)

  it 'Scenario 44. Two tags with two attributes, two spaces at the end of the two attributes', ->

    input = fs.readFileSync './test/scenarios/scenario-44-input.cohtml', 'utf8'
    # console.log input
    output = toHtml5 input
    # console.log output
    expectedOutput = fs.readFileSync './test/scenarios/scenario-44-expected.html', 'utf8'
    # console.log expectedOutput
    expect(output).to.equal(expectedOutput)

  it 'Scenario 45. Two tags with two attributes, two spaces at the beginning and end of the two attributes', ->

    input = fs.readFileSync './test/scenarios/scenario-45-input.cohtml', 'utf8'
    # console.log input
    output = toHtml5 input
    # console.log output
    expectedOutput = fs.readFileSync './test/scenarios/scenario-45-expected.html', 'utf8'
    # console.log expectedOutput
    expect(output).to.equal(expectedOutput)